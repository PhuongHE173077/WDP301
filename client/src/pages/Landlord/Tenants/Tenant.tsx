...
import { deleteTenantAPIs, fetchTenants } from "@/apis";
import UserFormDialog from "./components/DialogCreate";
...
export default function Tenant() {
    ...
    const handleDelete = async (user) => {
        Swal.fire({
            title: `Bạn muốn xóa phòng ${user.name} ?`,
            ...
            if (result.isConfirmed) {
                await deleteTenantAPIs(user._id);
                fetchData();
            }
        });
    }
    ...
    return (
        <Card className="p-4 space-y-4">
            ...
            <UserFormDialog open={open} setOpen={setOpen} fetchData={fetchData} />
        </Card>
    );
}
